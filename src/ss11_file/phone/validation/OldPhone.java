...
import ss11_file.phone.exception.MinLengthException;
import ss11_file.phone.exception.NumberOutOfRangeException;
...
public class OldPhone extends Phone implements Discount {
	...
	public OldPhone(String id, String namePhone, double price, int warranty, String manufacturer, int batteryStatus, String description) {
	...
	public String toString() {
		...
		return baseToCSV() + "," + batteryStatus + "," + description + ",";
	}
}
